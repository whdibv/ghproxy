...
- 🌍 **超大文件第三方分流**：超过 200MB 自动展示第三方高速节点（Cloudflare / Fastly / AxisNow 公共 CDN），不占用你的服务器带宽
...
A：虚拟主机通常只有 10Mbps 左右带宽，200MB 文件要传 20 多分钟，还容易触发主机限流。第三方节点（gh-proxy.org 系列）是公共 CDN 服务，速度和稳定性都远超个人虚拟主机。所有节点列表见首页说明，若某节点慢可切换其他节点。
